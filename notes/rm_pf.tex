...
\section{Modified DLM}

We allow additional covariates $U_t$ into the observation equation \eqref{eqn:obs} by including a term $U_t\beta$, where $U_t$ is a known $q$ by $d$ matrix and $\beta$ is an unknown $d$ by $1$ vector. In addition, we can allow $F$ to change over time. Thus, our DLM is now written as the following:
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/11-6-13/W-0.5-1-2/mc_1sim_test-states}
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/11-6-13/W-0.5-1-2/mc_1sim_test-precision}
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/11-6-13/W-0.5-1-2/mc_1sim_test-histograms}
\caption{Kernel density estimates of log marginal likelihoods of a single time series simulated from $M_2$, approximated assuming $M_2$ true using the resample-move particle filter, for each of 20 particle filter runs using 100 (white), 500 (dark gray), 1000 (light gray), and 5000 (black) particles.} \label{fig:pf-hist}
\end{figure}

\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/11-6-13/W-0.5-1-2/mc_1sim_test-ternary}
...
\begin{table}[h]
\centering
\caption{Contingency table of models with highest posterior model probability among three models calculated analytically and approximated using the resample-move particle filter with 1000 particles.}
\label{tab:cont-1000}
\begin{tabular}{|c|c|c|c|}
  \hline
 & \multicolumn{3}{|c|}{PF approximation} \\
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/11-6-13/W-0.5-1-2/mc_pf_test-ternary}
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/11-6-13/W-0.5-1-2/mc_pf_test-binary}
