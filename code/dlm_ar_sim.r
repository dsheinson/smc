...
# mydata = expand.grid(nsims = N, rho1 = seq(.2,.8,.2), sigma2s = seq(.5,2,.5))
...
require(plyr)
data1 = expand.grid(N = 20, n = 1:16, n.sim = 1, label = c("M101","M101-diff","M010","M011","M020"),d=3,stringsAsFactors=FALSE)
