...
require(doMC)
registerDoMC()
mydata = expand.grid(N=20,n=c(1,11,16),n.sim=1:20,mod=c("M101","M011"),diff="",dimx=2,n.chain=3,nsims=11000,nburn=1000,nthin=10,same=FALSE,progress=FALSE,print.iter=FALSE)
