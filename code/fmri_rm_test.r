...
require(doMC)
registerDoMC()
data1 = expand.grid(N = 20, mod.est = c("M101","M011"), dimx = 2, n.sim = 1:8, n.run = 1:3, mod.sim = c("M101","M011"), sd.fac = 1, n = 6, np = 100, progress = FALSE, save = TRUE, stringsAsFactors = FALSE)
data2 = expand.grid(N = 20, mod.est = c("M101","M011"), dimx = 2, n.sim = 1:8, n.run = 1:3, mod.sim = c("M101","M011"), sd.fac = 1, n = c(6,11,16), np = 100, progress = FALSE, save = FALSE)
data3 = expand.grid(N = 20, mod.est = c("M101","M011"), dimx = 2, n.sim = 1:8, n.run = 1:3, mod.sim = c("M101","M011"), sd.fac = c(3,5,7), n = 6, np = 100, progress = FALSE, save = FALSE)
