...
data1 = expand.grid(n.sim=rep(c(1,3),c(20,20)),np=c(100, 500, 1000, 5000), W=c(0.5,1,2), stringsAsFactors=FALSE)
data1 = data.frame(data1, label = 1:dim(data1)[1])
data2 = expand.grid(n.sim=c(2,4:20),np=c(100, 500, 1000, 5000), W=c(0.5,1,2), stringsAsFactors=FALSE)
