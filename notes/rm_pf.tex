...
%As mentioned in Section \ref{sec:estimation}, models of the form described by equations \eqref{eqn:obs} and \eqref{eqn:state} generally do not emit tractable forms of the posterior distribution $p(x_{1:t},\theta|y_{1:t})$. Thus, in many cases we must turn toward methods for approximating this distribution such as particle filtering. One specific type of particle filter known as the \emph{resample-move} algorithm was developed by \citet{Gilk:Berz:foll:2001, Berz:gilk:2001} and is summarized here.
%
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/10-23-13/mc_1sim_hist}
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/10-24-13/mc_pf_test-ternary}
...
\begin{figure}
\includegraphics[width=1.0\textwidth]{../graphs/10-24-13/mc_pf_test-binary}
