...
#' @param rprior a function to sample from the prior for the state and fixed parameters given the particle index j (needed if initial prior samples are already available); returns a list with elements x and theta
