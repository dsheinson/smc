...
require(mcmcse)
require(plyr)
mydata = expand.grid(N=20,n=6,n.sim=1,mod=c("M101","M011","M010","M020"),diff="",dimx=2,n.chains=3,nsims=11000,nburn=1000,nthin=10,same=FALSE,stringsAsFactors=FALSE)
m_ply(data1, fmri_mcmc_plot)